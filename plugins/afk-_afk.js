	...
	let too = `*🍁𝐌𝐎𝐍𝐊𝐄𝐘 𝐃 𝐋𝐔𝐅𝐅𝐘١⁵🍁*\n\nمثال:*\n* *${usedPrefix + command}* * LUFFY *+* BOT*`
       await conn.reply(m.chat, '*انتضر جار التنفيذ..*', fkontak, { contextInfo:{ forwardingScore: 2022, isForwarded: true, externalAdReply: {title: '𝐿𝑈𝐹𝐹𝑌-𝐵𝛩𝑇', body: `【𝟐𝟎𝟎𝟓/𝟐/𝟏𝟎】١⁵`, mediaType: 2, sourceUrl: , thumbnail: imagen1}}}, { quoted: m })
